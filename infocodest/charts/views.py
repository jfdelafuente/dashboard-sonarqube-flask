...
def charts_test():
    ...
    return render_template(
        "charts/charts_test.html", labels=labels, values=values, date=datetime.now()
    )
...
def charts_historico():
    ...
    if request.method == "POST":
        ...
        return render_template(
            "charts/charts_historico.html", apps=apps, date=datetime.now()
        )
...
def charts_radar(project, name):
    return render_template(
        "charts/charts_radar.html", project=project, name=name, date=datetime.now()
    )
