...
def get_distinct_providers():
    return (
        Proveedor.query.join(Metrica, Proveedor.aplicacion == Metrica.aplicacion)
...
def get_metricas():
    metricas = (
        Metrica.query.join(Proveedor, Proveedor.aplicacion == Metrica.aplicacion)
...
def get_stats():
    stats = (
        Stat.query.join(Proveedor, Proveedor.aplicacion == Stat.aplicacion)
        .with_entities(
            Stat.aplicacion,
            Stat.repos,
...
def get_stats_aplicacion(project):
    return (
        Stat.query.join(Proveedor, Stat.aplicacion == Proveedor.aplicacion)
...
def get_dailys():
    return (
        Daily.query.filter(Daily.created_on == date.today() - timedelta(days=1))
...
def get_historico_name(project, name):
    return (
        Historico.query.join(Proveedor, Historico.aplicacion == Proveedor.aplicacion)
